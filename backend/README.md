...
## Project Structure
    ...
    ├── testapiautoconnecto_56250  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_56250`
...
2. Clone this repo and `cd testapiautoconnecto_56250`
